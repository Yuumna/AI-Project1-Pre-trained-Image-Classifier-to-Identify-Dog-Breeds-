...
def calculates_results_stats(results_dic):
    ...
    # Calculates % correct for matches ('n_match') divided by the number of images('n_images')
    results_stats_dic['pct_match'] = (results_stats_dic['n_match'] /results_stats_dic['n_images'])*100.0
    # Calculates % correct dogs ('n_correct_dogs') divided by the number of dog images('n_dogs_img')
    results_stats_dic['pct_correct_dogs'] = (results_stats_dic['n_correct_dogs'] /results_stats_dic['n_dogs_img'])*100.0
    # Calculates % correct breed of dog ('n_correct_breed') divided by the number of dog images('n_dogs_img')
